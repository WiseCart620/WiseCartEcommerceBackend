...
public class Cart {
    ...
    @CollectionTable(name = "cart_coupons", joinColumns = @JoinColumn(name = "cart_id"))
    ...
    public void removeCoupon(String code) {
        couponCodes.remove(code.toUpperCase());
    }

// backwards compat getter — returns first code or null
    public String getCouponCode() {
        return couponCodes != null && !couponCodes.isEmpty() ? couponCodes.get(0) : null;
    }
}
