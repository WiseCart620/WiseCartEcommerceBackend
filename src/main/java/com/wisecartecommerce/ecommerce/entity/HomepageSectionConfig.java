...
public class HomepageSectionConfig {
    ...
    /**
     * Unique key identifying the section:
     * FEATURED, NEW_ARRIVALS, BEST_SELLERS, HOT_DEALS
     */
    ...
    /**
     * Manually selected products (used when mode = MANUAL).
     * Ordered by displayOrder in HomepageSectionProduct.
     */
